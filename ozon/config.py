...
COLLECT_OVERSHOOT = 3
# Страниц вопросов максимум. Новая лента отдаёт по 10 и листается курсором,
# так что это предохранитель от бесконечной пагинации, а не ожидаемая глубина.
QUESTION_PAGES = 40
